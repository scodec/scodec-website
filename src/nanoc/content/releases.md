...
## scodec-core
    ...
    libraryDependencies += "org.scodec" %% "scodec-core" % "1.7.0-RC2"
...
--------|---------|----------|-------|-------------|--------|-----------
1.7.0-RC2   | [Changes](https://github.com/scodec/scodec/blob/series/1.7.x/CHANGELOG.md) | [API](http://scodec.org/api/scodec-core/1.7.0-RC2) | 2.10, 2.11 | [1.0,2.0) | none | 2.1.0-RC2
...
## scodec-protocols
    ...
    libraryDependencies += "org.scodec" %% "scodec-protocols" % "0.7.0-SNAPSHOT"
...
--------|---------|----------|-------|---------------
0.7.0   | N/A     | [API](http://scodec.org/api/scodec-protocols/0.7.0-SNAPSHOT) | 2.10, 2.11 | 0.7.0
